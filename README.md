...
1. 17-October-24  Defined formally what NP Hard means. Dealing with NP-Complete problems. We saw the idea behind improved efficiency for exhaustive searching (idea of DPLL for SAT and Branch and bound for TSP). We saw two approximation algorithms - for minimum VC (using maximal matching) and minimum TSP using MST.  See pp. 269-290 ; we skipped Knapsack and K-Clustering.
1. 22-October-24  K-Clustering approximation algorithm see pp. 269-290 of DPV.  Las Vegas Algorithms - Randomized SAT solution, Leader Election in a ring (pp.  260-261 of BB). Monte-Carlo approximate algorithms -  Estimating integral, estimating the value of Pi, Majority element problem, Rabin's primality testing method. See pp. 268-270 of BB. IN general Chapter 8 of BB is a very nice overview of the breadth of randomized algorithms. Suggested extra reading (not covered in class/course ) Karger's randomized algorithm for min-cut - see [these notes](https://www.cs.princeton.edu/courses/archive/fall13/cos521/lecnotes/lec2final.pdf )
